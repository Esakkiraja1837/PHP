...
<hr>
    <form action="" method = "POST">
        <fieldset>
            ...
            <div class="lastname" >
            LastName 
            <input type = "text" class = "lname" name = "lastname" >
            <br><br></div></div>

            <div class="email-contact">
            <div class="email">
            <lable for = "email">Email Id </lable>
            <input type = "email" class = "mail" name = "emailid" >
            <br><br></div>

            <div class="contact" >
            Contact No 
            <input type = "text" class = "econtact" name = "contactnumber" >
            <br><br></div></div>
            ...
            Qualification
            <input type = "text" class = "equalification" name = "qualification" >
            <br><br></div></div>

            <div class="current_address" >
            <p><label for="address">Current_address </label></p>
            <textarea id="caddress" name="currentaddress" rows="2" cols="112" ></textarea>
            <br><br></div>

            <div class="permanent_address" >
            <p><label for="paddress">Permanent_address </label></p>
            <textarea id="paddress" name="permanentaddress" rows="2" cols="112" ></textarea>
            <br><br></div>

            <div class="exp_blood_gender">
            <div class="Year_of_experience" >
            <label for = "experience">Year_of_experience :</label>
            <input type = "number" id = "experience" min="0" max="50" class = "experience" name = "experience" >
            <br><br></div>
            ...
            Emergency number
            <input type = "text" class = "emergency" name = "emergencynumber" >
            <br><br></div>
